...
<body>
    <%String a=(String)session.getAttribute("unm").toString();%>
<!-- header -->
	<div class="header-w3ls-agileinfo">
		
			<div class="wthree_agile_top_header">
				<div class="logo-agileits">
                                    <h1><a href="home.jsp"><span>B</span>rilliance <i class="fa fa-graduation-cap" aria-hidden="true"></i></a></h1>
				</div>
	...
	<div class="container">
		...
		<div class="footer-main">
			...
			<div class="copyrights">
				<p>&copy; 2017 Brilliance. All Rights Reserved | Design by  <a href="" target="_blank"></a> </p>
			</div>
		</div>
	</div>
