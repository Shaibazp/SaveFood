                                ...
                                <%
                                    ...
                                    try 
                                    {
                                        ...
                                        while(rs1.next())
                                        {
                                            ...
                                            PreparedStatement pstn1 = con.prepareStatement("select * from foodreq where city=? AND sts = '0'");
                                            ...
                                            { 
                                                %>
                                                    <tr>
                                                        ...
                                                        <td><a href="update.jsp?a=<%= rs.getString(1)%>" class="btn btn-outline-primary">Accept</a></td>
                                                    </tr>
                                                <%
                                            }
                                        }
