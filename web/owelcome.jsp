            ...
            <div class="container py-lg-5 py-md-4 py-2">
                <div class="grids-area-hny main-cont-wthree-fea row">
                    <div class="col-lg-4 col-md-6 grids-feature">
                        <div class="area-box">
                            <img src="assets1/images/donate.png" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 grids-feature mt-md-0 mt-5">
                        <div class="area-box">
                            <img src="assets1/images/volunteer.png" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 grids-feature mt-lg-0 mt-5">
                        <div class="area-box">
                            <img src="assets1/images/child.png" alt="" width="52px"> 
            ...
            <div class="container py-lg-5 py-md-4">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <a href="" class="btn btn-outline-primary btn-style">Contact Us</a>
                    </div>
                    <div class="col-lg-4 col-md-6 mt-lg-0 mt-5">
                        <div class="img-block">
                            <a href="">
                                <img src="assets1/images/blog5.jpg" class="img-fluid radius-image-full" alt="image" />
                                <span class="title">Food for Hungry</span>
                            </a>
                        </div>
                        <div class="img-block mt-4">
                            <a href=""> <img src="assets1/images/blog2.jpg" class="img-fluid radius-image-full"
                                                        alt="image" />
                    ...
                    <div class="col-lg-4 col-md-6 mt-lg-0 mt-md-5 mt-4">
                        <div class="img-block">
                            <a href=""> <img src="assets1/images/blog3.jpg" class="img-fluid radius-image-full"
                                                        alt="image" />
                        ...
                        <div class="img-block mt-4">
                            <a href="">
                                <img src="assets1/images/blog4.jpg" class="img-fluid radius-image-full" alt="image" />
                    ...
                    <div class="fea-gd-vv row">
                        <div class="col-lg-4 col-md-6">
                            <div class="float-lt feature-gd">
                                <div class="icon">
                                    <img src="assets1/images/home.png" alt="" class="img-fluid">
                                </div>
                                <div class="icon-info">
                        ...
                        <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
                            <div class="float-mid feature-gd">
                                <div class="icon">
                                    <img src="assets1/images/education.png" alt="" class="img-fluid">
                                </div>
                                <div class="icon-info">
                        ...
                        <div class="col-lg-4 col-md-6 mt-lg-0 mt-4">
                            <div class="float-rt feature-gd">
                                <div class="icon">
                                    <img src="assets1/images/health.png" alt="" class="img-fluid">
                                </div>
                                <div class="icon-info">
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-md-2">
                            <div class="float-lt feature-gd">
                                <div class="icon">
                                    <img src="assets1/images/icon1.png" alt="" class="img-fluid">
                                </div>
                                <div class="icon-info">
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-md-2">
                            <div class="float-lt feature-gd">
                                <div class="icon">
                                    <img src="assets1/images/food.png" alt="" class="img-fluid">
                                </div>
                                <div class="icon-info">
                        ...
                        <div class="col-lg-4 col-md-6 mt-4 pt-md-2">
                            <div class="float-lt feature-gd">
                                <div class="icon">
                                    <img src="assets1/images/eco.png" alt="" class="img-fluid">
                                </div>
                                <div class="icon-info">
                                    <h5>Eco Charities.</h5>
                                    <p> Lorem ipsum dolor sit amet, dolor elit, sed eiusmod init
                    ...
                    <div class="company-logos text-center mt-5">
                        <div class="row logos">
                            <div class="col-lg-2 col-md-3 col-4">
                                <img src="assets1/images/brand1.png" alt="" class="img-fluid">
                            </div>
                            <div class="col-lg-2 col-md-3 col-4">
                                <img src="assets1/images/brand2.png" alt="" class="img-fluid">
                            </div>
                            <div class="col-lg-2 col-md-3 col-4">
                                <img src="assets1/images/brand3.png" alt="" class="img-fluid">
                            </div>
                            <div class="col-lg-2 col-md-3 col-4 mt-md-0 mt-4">
                                <img src="assets1/images/brand4.png" alt="" class="img-fluid">
                            </div>
                            <div class="col-lg-2 col-md-3 col-4 mt-lg-0 mt-4">
                                <img src="assets1/images/brand5.png" alt="" class="img-fluid">
                            </div>
                            <div class="col-lg-2 col-md-3 col-4 mt-lg-0 mt-4">
                                <img src="assets1/images/brand6.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
